...
namespace Desktop.States.Sesiones
{
    public class EditState : IFormState
    {
        ...
        {
            var currentRow = _form.dataGridSesionesView.CurrentRow;
            _form.sesionCurrent = currentRow != null ? currentRow.DataBoundItem as Sesion : null;
            if (_form.sesionCurrent != null)
            {
                // Seleccionar el turno asociado en el combo
                _form.comboTurnos.SelectedValue = _form.sesionCurrent.TurnoId;
